...
<div class="content-wrapper">
  ...
  <section class="content-header">
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa  fa-hourglass-end"></i>Cadangkan/Pulihkan</a></li>
      </ol>
  </section>
            ...
            ?>
             ...
             <li class="active">
                <a data-toggle="tab" href="#backup">
                 <i class="green ace-icon fa  fa-cloud-download bigger-120"></i> Cadangkan</a></li>
				 <li><a data-toggle="tab" href="#restore">
                 <i class="blue ace-icon fa  fa-cloud-upload bigger-120"></i> Pulihkan</a></li>
            </ul>
                ...
                <div class="post">
                  <br />
					<form action="" method="post" name="postform" enctype="multipart/form-data" >
                     <p>
                     <strong>Cadangkan</strong> semua data yang ada didalam database &quot;<strong><?= $database ?></strong>&quot;.</em>
                     </p>
                     <div class="asd">
                       <label for="backup">Cadangkan database</label>
					   <br />
                       <button id="loading-btn" type="submit" class="btn btn-success" name="backup" onClick="return pastikan('Backup database')">Proses Pencadangan</button>
                      </div>
                     </form>
                </div>
                <!-- /.post -->
			   ...
			   <div class="tab-pane" id="restore">
                ...
                <div class="post">
				  <br />
					<form action="" method="post" name="postform" enctype="multipart/form-data" >
                      <p>
                        <strong>Pulihkan</strong> semua data yang ada didalam database &quot;<strong><?= $database ?></strong>&quot;.</em>
                      </p>
                      <div class="asd">
                      <label for="backup">File Cadangan Database (*.sql)</label>
					  
                      <input type="file" name="datafile" size="20" class="filestyle" data-buttonName="btn-primary"/>
					  <br />
                      <button type="submit" class="btn btn-primary" name="restore" onClick="return pastikan('Backup database')" data-loading-text="Loading...">Proses Pemulihan</button>
                      </div>
                      </form>
                </div>
                <!-- /.post -->
