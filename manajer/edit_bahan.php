        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
              ...
              ?>
            <!-- form start -->
            <form role="form" action="fungsi.php?proses2=ubah_bahan" method="POST" class="form-horizontal">
              <div class="box-body">
			     <input type="hidden" class="form-control" name="id_bahan" value="<?php echo $id ?>">
     			 ...
     			 <div class="form-group">
				    ...
				    <div class="col-sm-4">
					  <input type="text" class="form-control" name="nama_bahan" value="<?php echo $r['nama_bahan']?>" onkeyup="this.value=this.value.replace(/[^\\a-z\\A-Z\\ \\]/g, '')" required>
				   </div>
               </div>
			      <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <a href="bahan.php?id_proyek=<?=$_GET['id_proyek']?>" class="btn btn-info btn-fill btn-wd">Batal</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
