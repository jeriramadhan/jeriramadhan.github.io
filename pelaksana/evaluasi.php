					 ...
					 <table id="tabel2" class="table table-bordered table-striped">
						<thead>
							  ...
							  <?php
							   ...
							   { 
								...
								$detail = mysql_query("select * from evaluasi where id_proyek = '$id_proyek' order by periode");
					  ...
					  if(isset($_GET['id_proyek'])) 
					   { 
					      ...
					      $query = mysql_query("SELECT * from evaluasi WHERE id_proyek = '$id_proyek' ORDER BY periode DESC limit 1");
