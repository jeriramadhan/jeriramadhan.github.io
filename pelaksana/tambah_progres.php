		...
		<br />
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Progres</h3>
			  <br />
            ...
            <form role="form" action=" " method="POST" class="form-horizontal">
              ...
              <!-- /.box-body -->
               ...
               <div class="box-body">
                  <div align="right">
                    <botton class="btn btn-success btn-fill btn-wd btn-sm"
                                  data-toggle="modal" data-target="#myModal">Tambah Progres</botton>
                  </div>
               </div>               
              <?php  
                ...
                <thead>
                            ...
                            <tr>
                              ...
                              ?>
                                ...
                                <td>
                                    ...
                                    data-toggle="modal" data-target="#myModal_hapus" data-whatever="fungsi.php?proses_hapus_detail=hapus_detail&id_proyek=<?=$_GET['id_proyek']?>&id_progres=<?=$_GET['id_progres']?>&id_detail_pro=<?=$r['id_detail_pro']?>"
                              >Hapus</botton>
							  </td>
							</tr>
                         <?php 
					  ...
					  ?>
                            ...
                            <tr>
								...
								<td> <a href="fungsi.php?proses_tambah=tambah_aktual&id_proyek=<?=$_GET['id_proyek']?>
								              &id_progres=<?=$_GET['id_progres']?>&bobot_realisasi=<?php echo $r1['total']?>&biaya_realisasi=<?php echo $r1['total2']?>"
								    class="btn btn-primary btn-fill btn-sm">Simpan</a>
							    </td>
                            </tr>
						</tbody>
                    </table>
               ...
               <div class="box-body">
				  <div class="form-group">
					...
					<select class="form-control select2" style="width:100%" name="id_sub">
						  <?php
							  $getbahan1 = mysql_query("SELECT * FROM master_sub_pekerjaan 
							  							JOIN sub_pekerjaan ON master_sub_pekerjaan.id_master_sub = sub_pekerjaan.id_master_sub
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Progres Penyelsaian  : </label>
                  <div class="col-sm-3">
				    <div class="input-group">
                       <input type="number" min="1" pattern=" >1"  id="numberbox" class="form-control" name="persen_r"  onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"required>
					   <span class="input-group-addon">%</span>
					</div>
                  </div>
               </div>
